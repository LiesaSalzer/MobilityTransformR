...
We developed the <code>MobilityTransformR</code> package to perform the 
...
raw_data <- readMSData(files = c("D:/Software/R/Packages/MobilityTransformR/inst/extdata/CEMS_10ppm.mzML", 
                               "D:/Software/R/Packages/MobilityTransformR/inst/extdata/CEMS_25ppm.mzML"), mode = "onDisk")
```
